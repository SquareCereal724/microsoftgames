...
╚══════════════════════════════════════════════════════.♥.═╝*/
	...
	***************************************************************************************************/
	window.getBallCodeInfo = function(value) {
		...
		switch(special) {
			...
			case 32: //Collect2
			case 33: //Collect3
				isGroupableByColor = 1;
				break;
			default:
				isGroupableByColor = 0;
				break;
		}
	...
	***************************************************************************************************/
	window.loadUtilData = function () {
		...
		window.outputConsole("◕‿◕ Load Util Data: " + sound + "," + music + "," + highContrast  + "," + ftue);

		//Construct callback
		c2_callFunction("CallBackLoadUtilData", [sound, music, highContrast, ftue]);
	};
	...
	***************************************************************************************************/
	window.createEmptyPlayerData = function () {
		...
		var levelsObj = {"c2array":true,"size":[100,3,1],"data": levels};
		...
		localStorage.setItem("microsoft.casualgames.msbubble.version1", JSON.stringify(window.gameLocalStorage));
	...
	***************************************************************************************************/
	window.savePlayerData = function (currency, PU_Amount_Target, PU_Amount_Rainbow, PU_Amount_Fireball, PU_Amount_Bomb, smallBallPack, levelsJSONString, purpleStars, infinityBestStrike, giftRewardStep) {
		...
		var levelsC2Array = {"c2array":true,"size":[100,3,1],"data": levelsJSON};
	...
	***************************************************************************************************/
	window.saveUtilData = function (sound, music, highContrast, ftue) {
		...
		window.outputConsole("◕‿◕ Save Util Data: " + sound + "," + music + "," + highContrast + "," + ftue);
	};
